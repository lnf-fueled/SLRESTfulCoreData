Pod::Spec.new do |spec|
  ...
  spec.license      = 'MIT'
  spec.source       = { :git => 'https://github.com/lnf-fueled/SLRESTfulCoreData.git', :tag => spec.version.to_s }
  spec.frameworks   = 'Foundation', 'UIKit', 'CoreData'
  spec.requires_arc = true
  spec.homepage     = 'https://github.com/lnf-fueled/SLRESTfulCoreData'
  ...
  spec.author       = { 'lnf-fueled' => 'lnf@fueled.com' }
